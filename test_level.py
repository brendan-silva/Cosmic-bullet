...
def scene() -> Scene:
    new_scene = Scene(Player(),enemy(Transform2D(0, 300, 0),pygame.image.load("Sprites\Enemy.png"),[100,135],[10,-60],1,[shotdata(Transform2D(0, 0, 0),pygame.image.load("Sprites\Enemy Bullet 1.png"),[10,0],[100,0],12,0.1,0,[0,30,0,0],[0,0,0,141])]) )
    return new_scene
